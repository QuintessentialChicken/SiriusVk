...
void srsPipeline::bind(VkCommandBuffer commandBuffer) {
    vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
}

void srsPipeline::getDefaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
...
void srsPipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo) {
    ...
    auto bindingDescriptions = srsModel::Vertex::getBindingDescriptions();
    auto attributeDescriptions = srsModel::Vertex::getAttributeDescriptions();
